...
You will be given an array of time taken by a 
candidate to solve a particular question and the 
total time the candidate takes to complete the interview.
...
function interview(qArray, totalTime) {
    if (totalTime > 120){
        return(console.log("disqualified"));
    }
    if ((qArray[0] || qArray[1]) > 5 ){
        console.log("disqualified");
        return(console.log("disqualified"));
    }
    if ((qArray[2] || qArray[3]) > 10 ){
        console.log("disqualified");
        return(console.log("disqualified"));
    }
    if ((qArray[4] || qArray[5]) > 15 ){
        console.log("disqualified");
        return(console.log("disqualified"));
    }
    if ((qArray[6] || qArray[7]) > 20 ){
        console.log("disqualified");
        return(console.log("disqualified"));
    }
    else {return console.log("qualified");}
}
...
//This exercise is extremely demoralizing.
